...
vars <-c("Total MA Market" = "value_1", "MA Part C Market" = "value_2", 
         "Total MA-C Enrolled" = "value_3", "Percent MA-C" = "value_4")

states <- c("Alabama" = "01", "Alaska" = "02", "Arizona" = "04", "Arkansas" = "05",
